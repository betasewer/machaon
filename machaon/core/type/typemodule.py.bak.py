...
from machaon.core.importer import TypeDescriberClass, attribute_loader
    ...
    def define(self, 
        ...
        *,
        ...
        if describer is None:
            ...
            # 実装を記述した辞書型
            t = Type(describer)
        elif isinstance(describer, TypeDescriberClass) or isinstance(describer, type):
            if not isinstance(describer, TypeDescriberClass):
